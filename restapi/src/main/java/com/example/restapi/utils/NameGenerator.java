...
public class NameGenerator {
     ...
     */
    private int generateLength(int maximo) {
        if (maximo <= 3) {
            return 3;
        }
     ...
     */
    public String createName(int tamannoMax) {
        String nombre = "";
        tamannoMax = generateLength(tamannoMax);
     ...
     */
    public String alterName(MultipartFile file) {
        ...
        sufijoImagen = this.createName(4);
