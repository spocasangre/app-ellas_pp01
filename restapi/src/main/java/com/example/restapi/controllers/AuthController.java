...
import com.example.restapi.models.dtos.*;
...
import com.example.restapi.utils.UserDetailsImpl;
    ...
    public ResponseEntity<?> signup(@Valid @RequestBody CreateAccountDTO createAccountDTO){
        try {
            if(userRepository.existsByCorreo(createAccountDTO.getCorreo())) {
                ...
                /*Usuario usuarioInFile = new Usuario();
                usuarioInFile.setNombre(createAccountDTO.getNombre());
                usuarioInFile.setTelefono(createAccountDTO.getTelefono());
                usuarioInFile.setCorreo(createAccountDTO.getCorreo());
                usuarioInFile.setPassword(createAccountDTO.getPassword());

                insertUserInFile.insertarUsuario(usuarioInFile);*/
