...
import com.example.restapi.services.firebase.PushNotificationService;
...
public class LocationController {
    ...
    private final static Logger LOGGER = Logger.getLogger("com.example.project.controllers.LocationController");
