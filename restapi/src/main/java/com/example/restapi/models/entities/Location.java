...
public class Location {
    ...
    public Location(Long id, Double latitud, Double longitud, String maps_id, String log_url ,String titulo, String descripcion, Usuario user) {
        super();
        this.id = id;
    ...
    public String getLog_url(){return log_url;}
