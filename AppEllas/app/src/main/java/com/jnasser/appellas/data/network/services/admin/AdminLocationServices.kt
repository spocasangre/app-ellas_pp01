...
import com.app.appellas.data.models.dtos.response.GeozoneResponse
...
interface AdminLocationServices {
    ...
    @GET("geozone")
    suspend fun getGeoZones(@Header("Authorization") token: String): Response<GenericResponse<List<GeozoneResponse>>>
